...
- НЕ добавляй хэштеги
- Если нужно выделить — используй HTML-теги <b> и <i>, но только при необходимости"""
...
Требования:
- 300–600 символов
- Структура: 🔄 [Заголовок] → детали сделки → реакция/контекст
...
- Добавь эмодзи команд
- НЕ используй Markdown (звёздочки, подчёркивания)
- НЕ добавляй хэштеги
- Используй HTML-теги <b> и <i> только для акцентов"""
